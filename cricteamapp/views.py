...
class PointList(View):
    def get(self,request):
        """View method for 'cricteam' app front page.
        :param request:
        :return: HttpResponse
        """
...
class TeamList(View):
    ...
    """View method for 'cricteam' app's teams' list page.
    :param request:
    :return: HttpResponse
    """
    def get(self,request):
...
class TeamDetails(View):
    """View method for 'cricteam' app's teams' details page.
    :param request:
    :param team_id:
    :return: HttpResponse
    """
...
class PlayerList(View):
    """View method for 'cricteam' app's players' list page.
    :param request:
    :return: HttpResponse
    """
    def get(self,request):
...
class PlayerDetails(View):
    """View method for 'cricteam' app's players' details page.
    :param request:
    :param player_id:
    :return: HttpResponse
    """
...
class MatchesCreate(View):
    """View method for 'cricteam' app's matches' creation page.
    :param request:
    :return: HttpResponse
    """
...
class MatchesFixturesCreate(View):
    """View method for 'cricteam' app's tournament fixtures' creation page.
    :param request:
    :return: HttpResponse
    """
    def dispatch(self,request):
...
class MatchesDetail(View):
    """View method for 'cricteam' app's matches' details page.
    :param request:
    :param match_id:
    :return: HttpResponse
    """
